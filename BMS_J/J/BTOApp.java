...
public class BTOApp {
    ...
    public void initialize() {
        ...
        projects = DataService.loadProjects(users);
        applications = DataService.loadApplications(projects);
        enquiries = DataService.loadEnquiries();
        officerRegistrations = DataService.loadOfficerRegistrations(users, projects);

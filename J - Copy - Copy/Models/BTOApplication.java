 ...
 * @param projectName The name of the project being applied for. Cannot be null.
 * @param flatTypeApplied The type of flat applied for. Cannot be null.
 * @param applicationDate The date the application was submitted. Cannot be null.
 ...
 * Includes warnings for potentially inconsistent data (e.g., BOOKED status with null flat type).
 *
 ...
 * @param flatTypeApplied The type of flat applied for. Can be null but issues warning if status implies it shouldn't be.
 ...
 */
    ...
    /**
     * Set the type of flat applied for.
     * 
     * @param flatTypeApplied The new flat type enum.
     */

...
public class ApplicantController extends BaseController {
    ...
    public ApplicantController(Map<String, User> users, List<Project> projects,
            Map<String, BTOApplication> applications, List<Enquiry> enquiries,
            Map<String, OfficerRegistration> officerRegistrations, User currentUser, Scanner scanner,
    ...
    public void viewMyApplication() {
        ...
        if (application == null) {
            System.out.println(
                    "Error: Your profile indicates an application, but the detailed record could not be found. Please contact support.");
            return;
        }
    ...
    public void requestWithdrawal() {
        ...
        if (application == null) {
            System.out.println(
                    "Error: Could not find the application record to request withdrawal. Please contact support.");
            return;
        }
    ...
    public void submitEnquiry() {
        ...
        if (selectedProject != null) {
            ...
            if (!viewableProjects.isEmpty())
                System.out.println("No project selected from list.");
    ...
    public void viewMyEnquiries() {
        ...
        List<Enquiry> myEnquiries = enquiries.stream()
                ...
                .sorted(
                        Comparator.comparing((Enquiry e) -> e.getEnquiryDate())
                                .reversed())
                .sorted(
                        Comparator.comparing((Enquiry e) -> e.getEnquiryDate())
                                .reversed())
    ...
    public void deleteMyEnquiry() {
        ...
        try {
            ...
            if (choice >= 1 && choice <= deletableEnquiries.size()) {
                ...
                System.out.print(
                        "Are you sure you want to delete enquiry " + enquiryToDelete.getEnquiryId() + "? (yes/no): ");
                String confirm = scanner.nextLine().trim().toLowerCase();
                if (confirm.equals("yes")) {
